...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        DROP INDEX IF EXISTS "uid_user_api_ke_key_307f5c";
        ALTER TABLE "user_api_keys" DROP COLUMN "key";"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "user_api_keys" ADD "key" VARCHAR(255) UNIQUE;"""
...
MODELS_STATE = (
    ...
    "eFtXmyrxnMQDYkk9zoTGOGYtPuhmBebjoxI0Hh/lsigPZUkMKBriF1MaF6hm7PZS9c4kLm"
    "TcEn3zMm5BGtu67q3r3np4lbju2wolr1dUYFM2O6yRd7NXMvx5yy/36CGK7XFH4yPNjuwV"
    "+Udwkac2m/nlLtDWPpOaVdmz2ttqnMBa1mQXhDgLr9Lw7bExSOtUxBQco1DcWfZmEljN7t"
    "95ewzlL7TO32NoY3uxVDbQrm1R9VaDDl//Dwyu6b8="
)
